...
export async function resolveConfig(
  ...
  const resolveOptions: ResolvedConfig['resolve'] = {
    ...
    ...config.resolve,
    alias: resolvedAlias,
    // This needs a mutable type, because `loadPackageData` will
    // mutate it to ensure resolved symlinks are analyzed for
    // CommonJS syntax when the symlink path is matched by
    // any of the `commonjsOptions.include` patterns.
    cjsInclude: cjsInclude as (string | RegExp)[] | undefined
  }
